        ...
        <div class="tarjeta">
            <div>
                <div class="acciones-superiores">
                    <button class="btn-crear" onclick="abrirModalDesdeTemplate('modal-crear-habitacion')">
                        <span class="material-symbols-rounded">add</span>Añadir habitación
                    </button>
           ...
           for (Habitacion h : lista) {
                                ...
                                <tr>
                                    ...
                                    <td><%= h.getEstado() %></td>
                                    <td>
                                        <button class="icono-boton" onclick="abrirModalModificar(<%= h.getId_hab() %>, <%= h.getNum_hab() %>, '<%= h.getTipo_nombre() %>', '<%= h.getEstado() %>')">
                                            <span class="material-symbols-rounded">wand_shine</span>
                                        </button>
                                    </td>
                                    <td>
                                        <form method="post" action="<%= request.getContextPath() %>/HabitacionController">
                                            <input type="hidden" name="accion" value="eliminar">
                                            <input type="hidden" name="id_hab" value="<%= h.getId_hab() %>">
